...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'inline_file_types' => '/\.(gif|jpe?g|png|pdf|docx|pptx|xls)$/i',
            ...
            'accept_file_types' => '/\.(gif|jpe?g|png|pdf|docx|pptx|xls)$/i',
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error, $index = null, $content_range = null) {
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            $sql = oci_parse($ORACLEconnection, "INSERT INTO HAKLABUPLOADS (BREAKDOWNNUM, IMAGE, CREATEDAT) VALUES ('".$_POST["breakdownnum"]."', '".$file->name."', to_date('".date("d.m.Y H:i:s")."','DD.MM.YYYY HH24:MI:SS'))");
            oci_execute($sql);
    ...
    public function post($print_response = true) {
        ...
        if ($upload) {
            ...
            if (is_array($upload['tmp_name'])) {
                ...
                //
                //$sql = oci_parse($ORACLEconnection, "INSERT INTO HAKASAPEXPERTISEUPLOADS (BREAKDOWNNUM, IMAGE) VALUES ('".$_POST["breakdownnum"]."', '".$upload['tmp_name']."')");
                //oci_execute($sql);
                //
                $files[] = $this->handle_file_upload(
